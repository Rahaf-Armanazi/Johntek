        ...
        <span style={{ marginRight: "8%", marginTop: "13%" }}> image : </span>
          ...
          <div className="upload-box">
            <input
              type="file"
              accept=".png, .jpg, .jpeg"
              onChange={(e) => handleFileChange(e, SetImage)} // إزالة الخاصية value
            />
            <div>
              <FontAwesomeIcon icon={faImage} fontSize="100px" style={{ marginTop: "10%", color: "rgb(135 148 171)" }} />
      ...
      <div className="pdf">
        <span style={{ marginRight: "8%", marginTop: "13%" }}> Pdf file : </span>
          ...
          <div className="upload-box">
            ...
            />
            <div>
              <FontAwesomeIcon icon={faFilePdf} fontSize="90px" style={{ marginTop: "20%", marginLeft: '5%', color: "rgb(135 148 171)" }} />
